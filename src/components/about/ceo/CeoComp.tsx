...
const CeoComp = () => {
  return (
    <section className="md:h-screen bg-[#101720] px-6 sm:px-12 md:px-16">
      <div className="flex flex-col items-center h-full justify-center py-16 space-y-10 md:flex-row md:space-y-0 md:space-x-4 max-w-5xl mx-auto">
