  ...
  return (
    <>
      <section className="bg-[#101720] flex flex-col items-center justify-center h-screen">
        ...
        {/* <div
          className={`flex space-x-2 mt-8 justify-center py-1 px-4 rounded-lg w-1/8 ${
            activeIndex !== -1 ? "border-2 border-dotted border-[#2159E7]" : ""
          }`}
        >
          {[0, 1, 2, 3].map((index) => (
            <motion.div
              ...
              className={`w-3 h-3 rounded-full cursor-pointer ${
                activeIndex === index ? "bg-[#2159E7]" : "bg-transparent border"
              }`}
            />
          ))}
        </div> */}
        ...
        <div className="flex flex-col items-center mt-16">
          ...
          <h1 className="text-[30px] font-inter text-white font-[600]">
